...
(function() {
  ...
  Postie.Client = (function() {
    ...
    function Client(serverUrl) {
      var _this = this;
      this._receive = function(rawEvent) {
        return Client.prototype._receive.apply(_this, arguments);
      };
      this._listen();
    ...
    Client.prototype.ready = function(callback) {
      ...
      return this._createFrame(this.serverUrl, function() {
        var uuid;
        uuid = _this._generateUuid();
        _this._dispatch(uuid, 'getEndpoints', true);
    ...
    Client.prototype._createEndpoints = function(endpoints) {
      ...
      _fn = function(endpoint) {
        return _this[endpoint] = function() {
          ...
          if (callback != null) {
            this._registerCallback(uuid, callback);
          }
          return this._dispatch(uuid, endpoint, data);
        };
      };
    ...
    Client.prototype._dispatch = function(uuid, method, data) {
      var payload;
    ...
    Client.prototype._receive = function(rawEvent) {
      ...
      return this._callbacks = _.filter(this._callbacks, function(cb) {
        return cb.uuid !== callback.uuid;
      });
    };
  ...
  Postie.Server = (function() {
    ...
    function Server(options) {
      ...
      this.receive = function(rawEvent) {
        return Server.prototype.receive.apply(_this, arguments);
      };
