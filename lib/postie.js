...
(function() {
  ...
  Postie.Client = (function() {
    ...
    Client.prototype._listen = function() {
      if (root.addEventListener != null) {
        return root.addEventListener('message', this._receive, false);
      } else if (root.attachEvent != null) {
        return root.attachEvent('onmessage', this._receive);
      } else {
